...
## Settings
### FC Score/Percentage main settings
...
### FC Score/Percentage Difference Colors sub-menu
| Setting name | Explanation / Info | Default value |
| --- | --- | --- |
...
### FC Score/Percentage Prefix Strings sub-menu
| Setting name | Explanation / Info | Default value |
| --- | --- | --- |
...
[The rest of this ReadMe has yet to be updated.]
 
## Old ReadMe 
Full Combo Percentage is a custom counter which is used with Counters+.
